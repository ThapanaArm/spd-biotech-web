...
const en = {
  ...
  hero: {
    ...
    titleA: "Science and ",
    titleB: "Pharmaceutical equipments",
    desc: "Innovative equipment and solutions for biotechnology, pharmaceutical, and life science industries.",
...
const th: Dictionary = {
  ...
  hero: {
    ...
    titleA: "วิทยาศาสตร์และ",
    titleB: "อุปกรณ์เภสัชกรรม",
    desc: "สินค้าสิ้นเปลืองและบริการให้คำปรึกษา สำหรับงานเภสัชกรรมและเทคโนโลยีชีวภาพ",
    explore: "ดูโซลูชัน",
    talk: "ปรึกษาวิศวกร →",
